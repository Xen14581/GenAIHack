from models import ModuleEvaluationResult, ModuleSchema, CodingRound, Question, Quiz, TestCase
...
def get_module_counts(module_id):
    ...
    coding_round_count = TestCase.query.filter_by(coding_round_id=coding_round.id).count()
