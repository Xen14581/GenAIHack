...
import { Box, Stack, Typography, FormControl, InputLabel, Select, MenuItem, Button } from '@mui/material';
import PlayArrowRoundedIcon from '@mui/icons-material/PlayArrowRounded';
import { useState, useRef } from 'react';
import { evaluateCode } from '../apis/code';

const CodeEditor = ({ codeTemplate, onSubmit }) => {
    ...
    const [state, setState] = useState({
        supportedLanguages: [{id: 1, name: "python"}],
        language: 'python',
        cursorPosition: [1, 1],
        code: codeTemplate,
    })
