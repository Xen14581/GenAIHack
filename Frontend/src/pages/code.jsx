...
const Code = () => {
  const [problem, setProblem] = useState({
    problemStatement:
      "Given an expression string exp. Examine whether the pairs and the orders of {},(),[] are correct in exp.For example, the function should return true for exp = [()]{}{[()()]()} and 'false' for exp = ([)]",
  ...
  return (
    <Grid container spacing={0} sx={{ width: "100%", pb: "1rem" }}>
      <Grid
        size={3}
        sx={{ border: 1, borderColor: "#000", borderWidth: "1px" }}
      >
        <ProblemPanel
